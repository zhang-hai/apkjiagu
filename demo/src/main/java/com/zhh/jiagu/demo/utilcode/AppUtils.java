...
public final class AppUtils {
    ...
    public static void launchApp(final String pkgName) {
        try {
            ...
            ToastUtils.showLong("无法打开 " + pkgName);
        }
    }
     ...
     * @param pkgName The name of the package.
     */
    public static void launchApp(final String pkgName, @Nullable final Bundle bundle) {
        if (isSpace(pkgName)) return;
        Context mContext = Utils.getApp().getApplicationContext();
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("AppUtils",Log.getStackTraceString(e));
        }
        if (packageinfo == null) {
            ToastUtils.showLong("未安装");
            return;
        }
        ...
        if (resolveinfo != null) {
            // packageName = 参数pkgName
            String packageName = resolveinfo.activityInfo.packageName;
            // 这个就是我们要找的该APP的LAUNCHER的Activity[组织形式：pkgName.launchActivity]
            ...
            // 设置ComponentName 参数1:packageName  参数2:LaunchActivityName
...
//        Utils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        SystemSettingUtils.openAppDetailSettings(Utils.getApp());
    }
