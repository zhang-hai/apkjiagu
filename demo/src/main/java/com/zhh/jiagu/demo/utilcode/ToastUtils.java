...
//        private static final LikeUtils.OnActivityDestroyedListener LISTENER =
//                new LikeUtils.OnActivityDestroyedListener() {
//                    @Override
...
//                };
        ...
        public void show() {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                Activity topActivity = ActivityStackManager.getInstance().getCurrentActivity();
                if (topActivity == null) {
                ...
                // LikeUtils.getActivityLifecycle().addOnActivityDestroyedListener(topActivity, LISTENER);
            } else {
                mWM = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
            ...
            HANDLER.postDelayed(this::cancel, mToast.getDuration() == Toast.LENGTH_SHORT ? 2000 : 3500);
        }
